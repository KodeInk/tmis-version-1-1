...
class Sys_file extends CI_Model {
	...
	function local_file_upload($file_obj, $file_stamp, $directory_name='', $returntype='filename', $counter='')
	{
		...
		$processing_results = $this->perfom_file_upload($this->libfileobj, $actual_file_obj, $file_stamp, UPLOAD_DIRECTORY.$directory_name."/", implode(',', $this->native_session->get('local_allowed_extensions')));
