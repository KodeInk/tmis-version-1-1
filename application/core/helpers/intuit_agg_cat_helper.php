<?php
/**
 * This file contains functions that are used in interacting with the Intuit API.
 * No attempt was made at cleaning up the code or modifying it to fit our coding standard.
 *
 ...
 * @added 12/19/2013
 *
 * More details at: http://aggcat.readthedocs.org/en/latest/
 */
...
class IntuitAggCatHelpers {
	...
	public static function GetOAuthTokens()
	{
		$saml_xml_request = IntuitAggCatHelpers::PrepSAMLAssertion();
		$tokens = IntuitAggCatHelpers::PrepOAuthViaSAML($saml_xml_request);
		
		return array('oauth_token'=>$tokens['oauth_token'], 'oauth_token_secret'=>$tokens['oauth_token_secret'] );
	}
	...
	// 
	public static function PrepOAuthViaSAML($saml_xml_request)
	{
