...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="1%" style="padding-bottom:0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="listtable">
      <tr>
        <td width="1%" class="control_prev" style=" cursor:pointer; padding:9px;line-height:0px;" onClick="updateViewedLayerTitle('left','merchant_dashboard')" id="left_arrow_box"><img src="<?php echo base_url();?>assets/images/left_arrow_big_grey.png" border="0"></td>
        <td class="mediumtext" style="text-align:center;line-height:17px;padding:10px; min-width:140px;" id="merchant_dashboard_view_title" nowrap>Profile View</td>
        <td width="1%" class="control_next" style="padding:9px; cursor:pointer; line-height:0px;" onClick="updateViewedLayerTitle('right','merchant_dashboard')" id="right_arrow_box"><img src="<?php echo base_url();?>assets/images/right_arrow_big_grey.png" border="0"></td>
      </tr>
    </table>
      <input type="hidden" name="merchant_dashboard_current" id="merchant_dashboard_current" value="0">
      <input type="hidden" name="merchant_dashboard_ids" id="merchant_dashboard_ids" value="profile_view_div|score_view_div|promo_view_div">
      <input type="hidden" name="merchant_dashboard_titles" id="merchant_dashboard_titles" value="Profile View|Score View|Promo View"></td>
