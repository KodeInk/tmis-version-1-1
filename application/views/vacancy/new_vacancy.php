...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td style="padding-right:42px;"><?php if(!empty($id) && $this->native_session->get('role__jobroles')){
		...
		} else {?><input type="text" id="role__jobroles" name="role__jobroles" title="Select Role" placeholder="Select Job Category" class="textfield selectfield" value="<?php echo $this->native_session->get('role__jobroles');?>" style="width:97%;"/><?php }?></td>
  </tr>
  <tr>
