...
<tr>
  ...
  <tr>
    <td colspan="2" class="greybg topwhiteborder"><div style="padding-left:1%;padding-top:10px;padding-bottom:10px;" class="logo h3 grey">TEACHER MANAGEMENT INFORMATION SYSTEM</div><div class="loginform"><?php echo $homeLink.$aboutLink.$faqsLink.$verifyLink;?></div></td>
  </tr>
  
  
  <tr><td colspan="2"><div class="greybg topwhiteborder centrallinks" style="text-align:center; padding-top:10px;padding-bottom:10px;"><?php echo $homeLink.$aboutLink.$faqsLink.$verifyLink;?></div></td></tr>
