...
?>
 <tr>
    <td colspan="2" class="bluebg"><div class="logo"><a href="<?php echo base_url().get_user_dashboard($this, $this->native_session->get('user_id'));?>"><img src="<?php echo base_url();?>assets/images/secure_tmis_logo.png" alt="TMIS logo" border="0"></a></div><div class="loginform largelinks">
    <table border="0" cellspacing="0" cellpadding="0">
    	<tr><td class="usericon<?php echo $class;?>">&nbsp;</td><td><a href="<?php echo base_url();?>profile/user_data" <?php echo $settingStyle;?>>My Settings</a></td><td style="padding-left:30px;">&nbsp;</td><td class="secureicon">&nbsp;</td><td><a href="<?php echo base_url();?>account/logout" class="yellow">Log Out</a></td></tr>
    </table>
    </div></td>
  </tr>
  <tr>
