...
<!-- Javascript -->
<?php echo minify_js('interview-list_interviews', array('jquery-2.1.1.min.js', 'jquery-ui.js', 'jquery.form.js', 'tmis.js', 'tmis.fileform.js', 'tmis.menu.js', 'tmis.responsive.js', 'tmis.list.js', 'tmis.shadowbox.js', 'tmis.pagination.js', 'tmis.search.js'));?>
</head>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
      		<tr>
              <td><div class="h1 grey nowrap listheader"><?php echo $listName;?>s</div><div class="listsearchfield"><input type="text" id="interviewsearch__interviews" data-type="interview" name="interviewsearch__interviews" placeholder="Search <?php echo $listName;?>s" class="findfield" value=""/>
<input type='hidden' id='interviewsearch__displaydiv' name='interviewsearch__displaydiv' value='interviewsearch__1' />
<input type='hidden' id='interviewsearch__action' name='interviewsearch__action' value='<?php echo base_url()."search/load_list/action/".(!empty($action)? $action: 'view');?>' />
</div></td></tr>
            <tr><td>
...
<input name="paginationdiv__interviewsearch_maxpages" id="paginationdiv__interviewsearch_maxpages" type="hidden" value="5" />
